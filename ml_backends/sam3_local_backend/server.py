...
DEFAULT_MODEL_DIR = Path(r"C:\Users\Administrator\.cache\modelscope\hub\models\facebook\sam3___1")
DEFAULT_SAM3_REPO = Path(r"C:\Users\Administrator\Developer\sam3")
DEFAULT_CHECKPOINT = DEFAULT_MODEL_DIR / "sam3.1_multiplex.pt"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(ROOT / "sam3_ml_backend.log", encoding="utf-8"),
    ],
)
logger = logging.getLogger("sam3_ml_backend")
